        ...
        <div class="sidebar" id="side_nav">
            ...
            <ul class="list-unstyled px-2">
                ...
                <li class=""><a href="#" class="text-decoration-none px-3 py-2 d-block"><i
                            class="bi bi-hospital" style="font-size: 20px;"></i> Rooms</a></li>
                <li class=""><a href="#" class="text-decoration-none px-3 py-2 d-block"><i
                            class="bi bi-people" style="font-size: 20px;"></i> Users</a></li>
                <li class=""><a href="#" class="text-decoration-none px-3 py-2 d-block"><i
                            class="bi bi-sliders" style="font-size: 20px;"></i> Settings</a></li>
        ...
        <div class="content">
                        ...
                        <div>
                            ...
                            <div class="frofile-card shadow rounded bg-white">
                                <div class="details d-flex gap-2 align-items-center p-3 w-100 h-75">
                                    <img class="img" src="/images/about/about.jpg">
                                    <div class="text-center d-flex flex-column justify-content-center">
                                        <p class="display">MR. Bee Minibaer</p>
                                        <span class="email">admin@example.com</span>
                                    </div>
                                </div>
                                <button onclick="onLogout()" class="action w-100 h-25 bg-dark text-light d-flex gap-2 align-items-center justify-content-center">
            ...
            <div class="dashboard-content px-3 pt-4">
                ...
                <p>
                    ...
                    sapiente vel autem repellendus molestiae quod nihil totam tempora quam quo iste. Neque pariatur
                    nobis molestiae nesciunt corporis nemo itaque voluptatem minima ducimus libero eligendi molestias,
                    deserunt placeat recusandae laboriosam fuga rem atque ea dolorum veritatis amet. A, rem. Cupiditate
                    suscipit reprehenderit a consequuntur eaque at similique cumque ipsam quis, eveniet nisi saepe modi?
                    Iste soluta maxime tenetur sunt error veritatis ut debitis veniam omnis aspernatur, consectetur hic
                    autem ratione, modi illo!
                </p>
            </div>
        </div>
    </div>
